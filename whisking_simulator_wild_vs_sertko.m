function [tip_dist,waveform,locomotive_path] = whisking_simulator_wild_vs_sertko(varargin)
...
[waveform,adapt_flag,no_free_whisk,t_start,init_phase,f_free,ret_free,pro_free,no_whisk,midline_angle,adapt_factor,duty_factor,ampl_mod_factor,caudal_dist, whisker_length,single_touch_dur,locomotive_path]=Initialize(genotype);
...
for it=1:no_whisk
    ...
    [f,no_free_whisk,t_start,t_cont,t,angle_ret]=M1_ret(genotype,t_start,init_phase,no_free_whisk,adapt_flag,adapt_factor,it,ampl_mod_factor,f_free,ret_free);
    ...
    [f,no_free_whisk,t_start,t_cont,t,angle_pro]=M1_pro(genotype,t_start,init_phase,adapt_flag,it,no_free_whisk,adapt_factor,ampl_mod_factor,duty_factor,f_free,pro_free);
