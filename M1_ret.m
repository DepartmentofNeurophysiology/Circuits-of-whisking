function [adapt,f,amp_mod,no_free_whisk,t_start,t_cont,t,angle_ret]=M1_ret(t_start,init_phase,no_free_whisk,adapt_flag,adapt_factor,it,ampl_mod_factor,f_free,ret_free);
