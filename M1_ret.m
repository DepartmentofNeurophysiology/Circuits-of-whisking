function [f,no_free_whisk,t_start,t_cont,t,angle_ret]=M1_ret(genotype,t_start,init_phase,no_free_whisk,adapt_flag,adapt_factor,it,ampl_mod_factor,f_free,ret_free);
...
t = (0:0.001:0+(1/(2*f)))';
angle_ret = amp_mod*ret_free* sin(2*pi*f*t+init_phase)+adapt; %M1 modulates whisking pattern through SC