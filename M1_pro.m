function [f,no_free_whisk,t_start,t_cont,t,angle_pro]=M1_pro(genotype,t_start,init_phase,adapt_flag,it,no_free_whisk,adapt_factor,ampl_mod_factor,duty_factor,f_free,pro_free);
