function [waveform,adapt_flag,no_free_whisk,t_start,init_phase,f_free,ret_free,pro_free,no_whisk,midline_angle,adapt_factor,duty_factor,ampl_mod_factor,caudal_dist, whisker_length,single_touch_dur,locomotive_path]=Initialize(genotype)
